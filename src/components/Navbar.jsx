      ...
      <nav>
        <div className="px-10 flex justify-between  items-center">
          {/* Logo on the extreme left */}
            <a href="/" className="text-black text-2xl font-bold flex flex-1 items-center">
              <svg
          ...
          <div className="flex flex-1 justify-end items-center space-x-4">
            ...
            <div className="flex items-center space-x-2 border p-2 rounded-full hover:shadow-md cursor-pointer">
              {/* Profile Icon */}
              <img
                width="30"
                height="30"
